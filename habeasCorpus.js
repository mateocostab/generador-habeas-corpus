...
function exportPDF() {
    ...
    if(conocimientoIdAutoridad ==='2'){
        ...
        doc.setFont('Times')
        //Strings 
        var p1 = 'Bajo la gravedad del juramento, que se considera prestado con la presentación de esta petición, manifiesto que ningún juez ha asumido el conocimiento de otra petición de habeas corpus ni decidido sobre la misma.',
        ...
        var c3p1="Yo,"+ iNombreS + ', en mi condición de ' + condicion+', '+mayoriaEdad +' y vecine de la ciudad de' + iCiudadS + ', identificade con cédula de ciudadanía'+ iNumeroCCS +'de'+ iCiudadCC + ', por medio del presente escrito acudo ante la autoridad judicial para solicitar se sirva dar trámite a la petición de HÁBEAS CORPUS en favor de ' + iNombreA + ', con fundamento en los siguientes:',
            ...
            c3p4='Efectua   da la verificación de la violación de las garantías constitucionales y legales, solicito a usted ordenar la libertad inmediata de' + iNombreA + 'y compulsar copias para que se inicien las investigaciones a que hubiere lugar'
            //splits
